...
const tests = process.argv.slice(2).length
  ...
  : ['rider-contract.test.ts', 'hardening.test.ts', 'i18n-parity.test.ts', 'safety.test.ts', 'vehicletools.test.ts', 'trips.test.ts', 'eas-mocks.test.ts', 'logistics.test.ts', 'offline.test.ts', 'web-automation.test.ts'];
