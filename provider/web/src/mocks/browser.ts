 ...
 * such as `/src/features/merchants/MerchantsPage.tsx` and would hijack lazy
 * route chunks with mock JSON. Guard every handler against those paths and
 * fall back to the original pattern matching for everything else.
 */
